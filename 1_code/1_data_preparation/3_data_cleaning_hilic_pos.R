...
sample_list <-
  readxl::read_xlsx("Stevenson Final List_pHILIC.xlsx",
                    sheet = 1,
                    col_types = "text")
...
sample_list3 <-
  sample_list %>%
  dplyr::mutate(sample_id = paste0(sample_id, "_Rerun"))

sample_list4 <-
  sample_list %>%
  dplyr::mutate(sample_id = paste0(sample_id, "_2"))

sample_list5 <-
  sample_list %>%
  dplyr::mutate(sample_id = paste0(sample_id, "-2"))
